...
/**
 * The base for all KlogHero plugins.
 */
abstract class KlogHeroPluginBase extends PluginBase implements KlogHeroPluginInterface, ContainerFactoryPluginInterface {
  /**
   * The current request
   *
   ...
   *  The entity type manager.
   */
  public function getEntiteTypeManager() {
